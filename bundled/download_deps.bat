...
powershell -NoProfile -Command "(New-Object System.Net.WebClient).DownloadFile('https://www.python.org/ftp/python/3.11.9/python-3.11.9-amd64.exe', '%BUNDLED%python-3.11.9-amd64.exe')"
...
powershell -NoProfile -Command "(New-Object System.Net.WebClient).DownloadFile('https://nodejs.org/dist/v20.18.0/node-v20.18.0-x64.msi', '%BUNDLED%node-v20.18.0-x64.msi')"
...
powershell -NoProfile -Command "(New-Object System.Net.WebClient).DownloadFile('https://ollama.com/download/OllamaSetup.exe', '%BUNDLED%OllamaSetup.exe')"
